...
<p>성별 : <input type="text" name="user_gender" /></p>
<p>생일 : <input type="text" name="user_birth" /></p>
<p>이메일 : <input type="text" name="user_email" /></p>
<p>전화번호 : <input type="text" name="user_phone" /></p>
<p>관심사 : <input type="text" name="user_interest" /></p>
